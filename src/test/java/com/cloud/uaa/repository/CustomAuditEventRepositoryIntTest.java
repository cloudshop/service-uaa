package com.cloud.uaa.repository;

import com.cloud.uaa.UaaApp;
import com.cloud.uaa.config.Constants;
import com.cloud.uaa.config.audit.AuditEventConverter;
import com.cloud.uaa.domain.PersistentAuditEvent;
...
import static com.cloud.uaa.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
